...
const resources = {
  en: {
    translation: {
      ...
      home_ground_title: "The shortest routes to your location.",
      ...
      ocean_cargo_msg2: "With our advanced tracking system, you can follow the journey of your cargo from departure to final destination, providing complete transparency throughout the supply chain. Being ranked among the top 10 largest Non-Vessel Operating Common Carriers (NVOCC) by Descartes underscores our expertise and commitment to excellence. This visibility and reliability ensure that you always know where your shipments are, reducing uncertainty and helping you make informed decisions every step of the way. At K&BD-LOGISTICS, we’re not just moving cargo—we’re streamlining your logistics for long-term success.",
  ...
  es: {
    translation: {
      ...
      supply_msg: "Entregamos soluciones esenciales en cadena de suministro a las principales empresas del mundo.",
      ...
      home_ground_title: "Las rutas más cortas a tu ubicación.",
      home_ground_msg: "Con rutas que abarcan todos los Estados Unidos, garantizamos que tus productos se entreguen de manera segura y puntual. Tu confianza es nuestra máxima prioridad, y te garantizamos que todo lo que envíes llegará a tus manos sin falta.",
      ...
      ground_cargo_title: "Rutas Confiables hacia Ti",
